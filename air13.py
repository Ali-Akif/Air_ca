...
def run_every_file(big_af_array):
    success_count = 0
    total_tests = 0

    for file_name, args_list in big_af_array.items():
...
tests = {"air00.py": [["Bonjour les gars"], ["Bonjour les gars"], ["Bonjour", "bonjour"]],
